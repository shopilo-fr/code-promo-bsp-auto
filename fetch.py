#!/usr/bin/env python3
"""
Recuperation des codes promo BSP Auto depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/bsp-auto.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/bsp-auto.com"
STORE_NAME = "BSP Auto"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour BSP Auto depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-bsp-auto)"
    }
    try:
